...
app.post('/processlogin', (req, res) => {
    ...
    User.findOne({ username }, function(err, result) {
       ...
       else {res.send("password check passed")} //if( bcrypt.compare(password, result.login.password)){res.send("password check passed");return}//{ req.session.loggedin = true; res.redirect('/dashboard') }
